...
void test_rs_core_mp_integer_signed_conversion_from_integer() {
    ...
    TEST(! x.in_range<std::uint16_t>());  TRY(u = x.maybe_cast<std::uint16_t>());  TEST(! u);
    TEST(x.in_range<std::int32_t>());     TRY(j = x.maybe_cast<std::int32_t>());   TEST(j); TEST_EQUAL(*j, -32'767l);
    TEST(! x.in_range<std::uint32_t>());  TRY(v = x.maybe_cast<std::uint32_t>());  TEST(! v);

    TRY(x = -32'768l);
    TEST(x.in_range<std::int16_t>());     TRY(i = x.maybe_cast<std::int16_t>());   TEST(i); TEST_EQUAL(*i, -32'768l);
    TEST(! x.in_range<std::uint16_t>());  TRY(u = x.maybe_cast<std::uint16_t>());  TEST(! u);
    TEST(x.in_range<std::int32_t>());     TRY(j = x.maybe_cast<std::int32_t>());   TEST(j); TEST_EQUAL(*j, -32'768l);
    TEST(! x.in_range<std::uint32_t>());  TRY(v = x.maybe_cast<std::uint32_t>());  TEST(! v);
    ...
    TEST(! x.in_range<std::int16_t>());   TRY(i = x.maybe_cast<std::int16_t>());   TEST(! i);
    TEST(! x.in_range<std::uint16_t>());  TRY(u = x.maybe_cast<std::uint16_t>());  TEST(! u);
    TEST(x.in_range<std::int32_t>());     TRY(j = x.maybe_cast<std::int32_t>());   TEST(j); TEST_EQUAL(*j, -32'769l);
    TEST(! x.in_range<std::uint32_t>());  TRY(v = x.maybe_cast<std::uint32_t>());  TEST(! v);
    ...
    TEST(! x.in_range<std::int16_t>());   TRY(i = x.maybe_cast<std::int16_t>());   TEST(! i);
    TEST(! x.in_range<std::uint16_t>());  TRY(u = x.maybe_cast<std::uint16_t>());  TEST(! u);
    TEST(x.in_range<std::int32_t>());     TRY(j = x.maybe_cast<std::int32_t>());   TEST(j); TEST_EQUAL(*j, -65'537l);
    TEST(! x.in_range<std::uint32_t>());  TRY(v = x.maybe_cast<std::uint32_t>());  TEST(! v);
