...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_core_mp_integer_signed_format, "test_rs_core_mp_integer_signed_format");
    ...
    call_me_maybe(test_rs_core_mp_integer_unsigned_format, "test_rs_core_mp_integer_unsigned_format");
    ...
    call_me_maybe(test_rs_core_range_cartesian_power, "test_rs_core_range_cartesian_power");
