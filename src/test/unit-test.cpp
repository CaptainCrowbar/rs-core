...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_core_rational_int_conversion, "test_rs_core_rational_int_conversion");
    ...
    call_me_maybe(test_rs_core_rational_mp_integer_conversion, "test_rs_core_rational_mp_integer_conversion");
