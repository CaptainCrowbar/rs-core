...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_core_arithmetic_geometry_functions, "test_rs_core_arithmetic_geometry_functions");
    call_me_maybe(test_rs_core_astronomy_constants, "test_rs_core_astronomy_constants");
    call_me_maybe(test_rs_core_astronomy_mass_density, "test_rs_core_astronomy_mass_density");
    call_me_maybe(test_rs_core_astronomy_surface_gravity, "test_rs_core_astronomy_surface_gravity");
    call_me_maybe(test_rs_core_astronomy_orbital_period, "test_rs_core_astronomy_orbital_period");
    call_me_maybe(test_rs_core_astronomy_hill_sphere, "test_rs_core_astronomy_hill_sphere");
    call_me_maybe(test_rs_core_astronomy_stellar_luminosity, "test_rs_core_astronomy_stellar_luminosity");
    call_me_maybe(test_rs_core_astronomy_stellar_lifetime, "test_rs_core_astronomy_stellar_lifetime");
    call_me_maybe(test_rs_core_astronomy_schwarzschild_radius, "test_rs_core_astronomy_schwarzschild_radius");
    call_me_maybe(test_rs_core_astronomy_magnitude_luminosity, "test_rs_core_astronomy_magnitude_luminosity");
    call_me_maybe(test_rs_core_astronomy_bolometric_correction, "test_rs_core_astronomy_bolometric_correction");
    call_me_maybe(test_rs_core_astronomy_planet_temperature, "test_rs_core_astronomy_planet_temperature");
    call_me_maybe(test_rs_core_bitwise_integer_small_uint_5, "test_rs_core_bitwise_integer_small_uint_5");
    ...
    call_me_maybe(test_rs_core_dice_basic_parsing, "test_rs_core_dice_basic_parsing");
    call_me_maybe(test_rs_core_dice_basic_generation, "test_rs_core_dice_basic_generation");
    call_me_maybe(test_rs_core_dice_set_formatting, "test_rs_core_dice_set_formatting");
    call_me_maybe(test_rs_core_dice_set_parsing, "test_rs_core_dice_set_parsing");
    call_me_maybe(test_rs_core_dice_set_statistics, "test_rs_core_dice_set_statistics");
    call_me_maybe(test_rs_core_dice_set_generation, "test_rs_core_dice_set_generation");
    call_me_maybe(test_rs_core_dice_state_construction, "test_rs_core_dice_state_construction");
    call_me_maybe(test_rs_core_dice_state_formatting, "test_rs_core_dice_state_formatting");
    call_me_maybe(test_rs_core_dice_state_enumeration, "test_rs_core_dice_state_enumeration");
    call_me_maybe(test_rs_core_dice_state_iteration, "test_rs_core_dice_state_iteration");
    call_me_maybe(test_rs_core_dice_state_probability, "test_rs_core_dice_state_probability");
    ...
    call_me_maybe(test_rs_core_format_parse_integers_maybe, "test_rs_core_format_parse_integers_maybe");
    ...
    call_me_maybe(test_rs_core_interpolate_logarithmic_multipoint, "test_rs_core_interpolate_logarithmic_multipoint");
    call_me_maybe(test_rs_core_interpolate_lagrange_polynomial, "test_rs_core_interpolate_lagrange_polynomial");
    call_me_maybe(test_rs_core_interpolate_cubic_spline, "test_rs_core_interpolate_cubic_spline");
    ...
    call_me_maybe(test_rs_core_linear_algebra_concepts, "test_rs_core_linear_algebra_concepts");
    ...
    call_me_maybe(test_rs_core_linear_algebra_matrix_basics, "test_rs_core_linear_algebra_matrix_basics");
    call_me_maybe(test_rs_core_linear_algebra_matrix_inversion, "test_rs_core_linear_algebra_matrix_inversion");
    call_me_maybe(test_rs_core_linear_algebra_quaternion, "test_rs_core_linear_algebra_quaternion");
    call_me_maybe(test_rs_core_linear_algebra_transform_2d, "test_rs_core_linear_algebra_transform_2d");
    call_me_maybe(test_rs_core_linear_algebra_transform_3d, "test_rs_core_linear_algebra_transform_3d");
    call_me_maybe(test_rs_core_linear_algebra_transform_projective_geometry, "test_rs_core_linear_algebra_transform_projective_geometry");
    ...
    call_me_maybe(test_rs_core_ring_buffer_basic_queue_eject, "test_rs_core_ring_buffer_basic_queue_eject");
    call_me_maybe(test_rs_core_ring_buffer_basic_queue_reject, "test_rs_core_ring_buffer_basic_queue_reject");
    call_me_maybe(test_rs_core_ring_buffer_basic_stack_eject, "test_rs_core_ring_buffer_basic_stack_eject");
    call_me_maybe(test_rs_core_ring_buffer_basic_stack_reject, "test_rs_core_ring_buffer_basic_stack_reject");
    call_me_maybe(test_rs_core_ring_buffer_static_queue_eject, "test_rs_core_ring_buffer_static_queue_eject");
    call_me_maybe(test_rs_core_ring_buffer_static_queue_reject, "test_rs_core_ring_buffer_static_queue_reject");
    call_me_maybe(test_rs_core_ring_buffer_static_stack_eject, "test_rs_core_ring_buffer_static_stack_eject");
    call_me_maybe(test_rs_core_ring_buffer_static_stack_reject, "test_rs_core_ring_buffer_static_stack_reject");
    call_me_maybe(test_rs_core_root_finding_bisection, "test_rs_core_root_finding_bisection");
    ...
    call_me_maybe(test_rs_core_statistics_univariate, "test_rs_core_statistics_univariate");
    call_me_maybe(test_rs_core_statistics_bivariate, "test_rs_core_statistics_bivariate");
    call_me_maybe(test_rs_core_statistics_combination, "test_rs_core_statistics_combination");
