...
void test_rs_core_statistics_univariate() {
...
void test_rs_core_statistics_bivariate() {
    ...
    TEST_NEAR(stats.x_raw_sd(),     28.866'070, 1e-6);
    ...
    TEST_NEAR(stats.y_raw_sd(),     276'140.408'219, 1e-6);
...
void test_rs_core_statistics_combination() {

    Statistics<> stats1, stats2, stats3;
    ...
    TEST_NEAR(stats3.y_raw_sd(),     276'140.408'219, 1e-6);
