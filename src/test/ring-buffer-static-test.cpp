...
void test_rs_core_ring_buffer_static_queue_eject() {

    Tracked::reset();

    {

        RingBuffer<Tracked, RingPolicy::queue | RingPolicy::evict, 5> buf;
        std::string str;
...
void test_rs_core_ring_buffer_static_queue_reject() {

    Tracked::reset();

    {

        RingBuffer<Tracked, RingPolicy::queue | RingPolicy::reject, 5> buf;
        std::string str;
...
void test_rs_core_ring_buffer_static_stack_eject() {

    Tracked::reset();

    {

        RingBuffer<Tracked, RingPolicy::stack | RingPolicy::evict, 5> buf;
        std::string str;
...
void test_rs_core_ring_buffer_static_stack_reject() {

    Tracked::reset();

    {

        RingBuffer<Tracked, RingPolicy::stack | RingPolicy::reject, 5> buf;
        std::string str;
