...
void test_rs_core_constants() {
    ...
    namespace C = RS::Constants;

    static_assert(std::same_as<decltype(speed_of_light),                 const double>);
    static_assert(std::same_as<decltype(speed_of_light_v<float>),        const float>);
    static_assert(std::same_as<decltype(speed_of_light_v<double>),       const double>);
    static_assert(std::same_as<decltype(speed_of_light_v<long double>),  const long double>);
