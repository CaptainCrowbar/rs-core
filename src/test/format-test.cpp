...
namespace MyNamespace {
    ...
    void rs_core_format(Alpha);
    void rs_core_format(Bravo);
    void rs_core_format(Charlie);
    void rs_core_format(Delta);
    void rs_core_format(Echo);
    void rs_core_format(Foxtrot);
    void rs_core_format(Golf);
    void rs_core_format(Hotel);
