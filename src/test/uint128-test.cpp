...
void test_rs_core_uint128_formatting() {
    ...
    TEST_EQUAL(u.to_string(),             "0");
    TEST_EQUAL(v.to_string(),             "305419896");
    TEST_EQUAL(w.to_string(),             "2882400255");
    TEST_EQUAL(x.to_string(),             "24197857203266734884469844682461802258");
    TEST_EQUAL(u.to_string(10, 15),       "000000000000000");
    TEST_EQUAL(v.to_string(10, 15),       "000000305419896");
    TEST_EQUAL(w.to_string(10, 15),       "000002882400255");
    TEST_EQUAL(x.to_string(10, 15),       "24197857203266734884469844682461802258");
    ...
    TEST_EQUAL(u.to_string(16),           "0");
    TEST_EQUAL(v.to_string(16),           "12345678");
    TEST_EQUAL(w.to_string(16),           "abcdefff");
    TEST_EQUAL(x.to_string(16),           "123456789abcdef123456789abcdef12");
    TEST_EQUAL(u.to_string(16, 15),       "000000000000000");
    TEST_EQUAL(v.to_string(16, 15),       "000000012345678");
    TEST_EQUAL(w.to_string(16, 15),       "0000000abcdefff");
    TEST_EQUAL(x.to_string(16, 15),       "123456789abcdef123456789abcdef12");
    ...
    TEST_EQUAL(u.to_string(2),            "0");
    TEST_EQUAL(v.to_string(2),            "10010001101000101011001111000");
    TEST_EQUAL(w.to_string(2),            "10101011110011011110111111111111");
    TEST_EQUAL(x.to_string(2),            "10010001101000101011001111000100110101011110011011110111100010010001101000101011001111000100110101011110011011110111100010010");
    TEST_EQUAL(u.to_string(2, 30),        "000000000000000000000000000000");
    TEST_EQUAL(v.to_string(2, 30),        "010010001101000101011001111000");
    TEST_EQUAL(w.to_string(2, 30),        "10101011110011011110111111111111");
    TEST_EQUAL(x.to_string(2, 30),        "10010001101000101011001111000100110101011110011011110111100010010001101000101011001111000100110101011110011011110111100010010");
