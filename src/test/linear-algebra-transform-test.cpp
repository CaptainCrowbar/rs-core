...
void test_rs_linear_algebra_transform_projective_geometry() {
    ...
    TRY((v3 = {10.0,20.0,30.0}));       TRY(v4 = point4(v3));   TEST_EQUAL(std::format("{}", v4), "[10,20,30,1]");
    TRY((v3 = {10.0,20.0,30.0}));       TRY(v4 = normal4(v3));  TEST_EQUAL(std::format("{}", v4), "[10,20,30,0]");
    TRY((v4 = {10.0,20.0,30.0,40.0}));  TRY(v3 = point3(v4));   TEST_EQUAL(std::format("{}", v3), "[0.25,0.5,0.75]");
    TRY((v4 = {10.0,20.0,30.0,40.0}));  TRY(v3 = normal3(v4));  TEST_EQUAL(std::format("{}", v3), "[10,20,30]");
...
void test_rs_linear_algebra_transform_primitives() {
    ...
    static const auto w = Double3::unit(2);
    ...
    TRY(fuzz(m3));
    TEST_EQUAL(std::format("{:.4f}", m3),
        "[[1.0000,0.0000,0.0000],"
        "[0.0000,0.8660,-0.5000],"
        "[0.0000,0.5000,0.8660]]"
    );

    TRY(r = m3 * u);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[1.0000,0.0000,0.0000]");
    TRY(r = m3 * v);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.8660,0.5000]");
    TRY(r = m3 * w);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,-0.5000,0.8660]");
    ...
    TRY(r = m3 * u);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.0000,-0.5000]");
    TRY(r = m3 * v);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,1.0000,0.0000]");
    TRY(r = m3 * w);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.5000,0.0000,0.8660]");
    ...
    TRY(r = m3 * u);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.5000,0.0000]");
    TRY(r = m3 * v);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[-0.5000,0.8660,0.0000]");
    TRY(r = m3 * w);  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.0000,1.0000]");

    TRY(m4 = rotate4(30_deg, 0));
    TRY(fuzz(m4));
    TEST_EQUAL(std::format("{:.4f}", m4),
    ...
    TRY(r = point3(m4 * point4(u)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[1.0000,0.0000,0.0000]");
    TRY(r = point3(m4 * point4(v)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.8660,0.5000]");
    TRY(r = point3(m4 * point4(w)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,-0.5000,0.8660]");
    ...
    TRY(r = point3(m4 * point4(u)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.0000,-0.5000]");
    TRY(r = point3(m4 * point4(v)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,1.0000,0.0000]");
    TRY(r = point3(m4 * point4(w)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.5000,0.0000,0.8660]");
    ...
    TRY(r = point3(m4 * point4(u)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.5000,0.0000]");
    TRY(r = point3(m4 * point4(v)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[-0.5000,0.8660,0.0000]");
    TRY(r = point3(m4 * point4(w)));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.0000,1.0000]");
    ...
    TRY(m3 = scale3(42.0));
    TEST_EQUAL(std::format("{}", m3),
        "[[42,0,0],"
        "[0,42,0],"
        "[0,0,42]]"
    );
    TRY(r = m3 * p);
    TEST_EQUAL(std::format("{}", r), "[84,126,210]");
    ...
    TRY(r = m3 * p);
    TEST_EQUAL(std::format("{}", r), "[20,60,150]");

    TRY(m4 = scale4(42.0));
    TEST_EQUAL(std::format("{}", m4),
        "[[42,0,0,0],"
        "[0,42,0,0],"
        "[0,0,42,0],"
        "[0,0,0,1]]"
    ...
    TRY(r = point3(m4 * point4(p)));
    TEST_EQUAL(std::format("{}", r), "[12,23,35]");
...
void test_rs_linear_algebra_transform_quaternions() {
    ...
    TRY(q = q_rotate(120_deg, p));
    TEST_EQUAL(std::format("{:.4f}", q), "Q[0.5000,0.5000,0.5000,0.5000]");

    TRY(q = q_rotate(120_deg, z));
    TEST_EQUAL(std::format("{}", q), "Q[1,0,0,0]");
    TRY(m3 = rotate3(q));
    TEST_EQUAL(std::format("{}", m3),
        "[[1,0,0],"
        "[0,1,0],"
    ...
    TRY(r = rotate(q, u));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[1.0000,0.0000,0.0000]");
    TRY(r = rotate(q, v));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.8660,0.5000]");
    TRY(r = rotate(q, w));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,-0.5000,0.8660]");

    TRY(q = q_rotate(30_deg, v));
    TRY(m3 = rotate3(q));
    TRY(fuzz(m3));
    TEST_EQUAL(std::format("{:.4f}", m3),
        "[[0.8660,0.0000,0.5000],"
    ...
    TRY(r = rotate(q, u));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.0000,-0.5000]");
    TRY(r = rotate(q, v));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,1.0000,0.0000]");
    TRY(r = rotate(q, w));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.5000,0.0000,0.8660]");

    TRY(q = q_rotate(30_deg, w));
    TRY(m3 = rotate3(q));
    TRY(fuzz(m3));
    TEST_EQUAL(std::format("{:.4f}", m3),
        "[[0.8660,-0.5000,0.0000],"
    ...
    TRY(r = rotate(q, u));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.8660,0.5000,0.0000]");
    TRY(r = rotate(q, v));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[-0.5000,0.8660,0.0000]");
    TRY(r = rotate(q, w));  TRY(fuzz(r));  TEST_EQUAL(std::format("{:.4f}", r), "[0.0000,0.0000,1.0000]");
