...
namespace RS {
    ...
    public:
        ...
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_YIELDS_RT
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_T_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_T_YIELDS_RT
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_TPTR_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_U_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_UPTR_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_U_T_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_T_T_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_T_T_UPTR_YIELDS_T
        #undef RS_CORE_DEFINE_ALIAS_MATHS_FUNCTION_U_U_T_YIELDS_T
...
#undef RS_CORE_DEFINE_ALIAS_STD_NUMBERS_CONSTANT
