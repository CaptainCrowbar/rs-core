...
computers and C++ implementations. This is not fully possible for floating
...
because the standard versions inconveniently have a gratuitously non-const
...
These return unbounded ranges using random iterator objects based on the
distribution and engine passed as arguments.
